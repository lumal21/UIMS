...
class Handler extends PrettyPageHandler
{
	...
	{
		(new Helper)->setH(['page_title' => $this->getPageTitle(),
		                    ...
		                    'tables' => array_map('UIoT\App\Core\Helpers\Manipulators\Json::isInstanceOfClosure', $this->getDataTables())])->render($this->getResource('Layouts/layout.html.php'));
		return Handler::QUIT;
	}
}
