    ...
    public function parse($requestContent)
    {
        if (is_bool($requestContent)) {
            RequestParserMethods::parseResponseWithRequestStatus(RaiseCodeMessageHandler::getInstance(), $this,
                DataTreater::generateResponseCode($requestContent, ['code' => '200',
                    'message' => 'RAISE received the sent data. <br/>Operation Method: ' . Constants::returnConstant('REQUEST_METHOD')]));
