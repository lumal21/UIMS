        ...
        <div class="frame-code <?php echo ($i == 0) ? 'active' : '' ?>" id="frame-code-<?php echo $i ?>">
            <div class="frame-file">
                ...
                <?php if ($filePath && $editorHref = $handler->getEditorHref($filePath, (int)$line)): ?>
                    ...
                    <a href="<?php echo $editorHref ?>"
                       class="editor-link"<?php echo($handler->getEditorAjax($filePath, (int)$line) ? ' data-ajax' : '') ?>>
            ...
            if ($line !== null):
                ...
                if ($range):
                    ...
                    ?>
                    <pre
                        class="code-block prettyprint linenums:<?php echo $start ?>"><?php echo $tpl->escape($code) ?></pre>
                <?php endif ?>
            <?php endif ?>
