...
use Httpful\Http;
use UIoT\App\Classes\Communication\Requesting\Rest;
...
class DataCollector
{
    ...
    {
        return Rest::doRequest(DataManager::getController() . '/');
    }
    ...
    {
        return ($collector->__passRequest(self::doRequest())->__passHandler($handler));
    }
